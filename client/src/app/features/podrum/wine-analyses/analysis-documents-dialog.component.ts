...
@Component({
  selector: 'app-analysis-documents-dialog',
  standalone: true,
  ...
  template: `
    ...
    >
      @if (visible && analysisId) {
        <app-documents-panel entityType="wine_analysis" [entityId]="analysisId"></app-documents-panel>
      }
    </p-dialog>
  `
})
export class AnalysisDocumentsDialogComponent {
  @Input() visible = false;
